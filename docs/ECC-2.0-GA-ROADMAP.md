...
3. Add live-judgment audit trails on top of the #72 gated model execution path
   so any promotion policy decision can be replayed before it becomes
   enforceable.
